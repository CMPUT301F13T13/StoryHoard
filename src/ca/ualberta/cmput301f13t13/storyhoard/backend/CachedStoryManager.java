 ...
 * @see StoringManager
 */
public class CachedStoryManager extends StoryManagerHelper implements StoringManager {
	private static DBHelper helper = null;
	private static CachedStoryManager self = null;

	/**
	 * Initializes a new OwnStoryManager object.
	 */
	protected CachedStoryManager(Context context) {
	 ...
	 */
	public static CachedStoryManager getInstance(Context context) {
		if (self == null) {
			self = new CachedStoryManager(context);
		}
		return self;
	}

	/**
	 * Saves a cached story locally (in the database). You can insert
	...
	public void update(Object newObject) {
		super.update(newObject, CachedStoryTable.TABLE_NAME, helper);
	}
	...
	public ArrayList<Object> retrieve(Object criteria) {
		return super.retrieve(criteria, CachedStoryTable.TABLE_NAME, helper);
	}
}
